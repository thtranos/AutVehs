...
class PPO4:
	...
	def load_component(self, component, agent):
		#self.policy_old.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_23/agents/{agent}", map_location=lambda storage, loc: storage))
		#self.policy.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_23/agents/{agent}", map_location=lambda storage, loc: storage))
		self.policy_old.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_403/agents/{agent}", map_location=lambda storage, loc: storage))
		self.policy.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_403/agents/{agent}", map_location=lambda storage, loc: storage))
