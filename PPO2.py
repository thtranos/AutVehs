...
class PPO2:
	...
	def load_component(self, component, agent):
		#self.policy_old.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_21/agents/{agent}", map_location=lambda storage, loc: storage))
		#self.policy.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_21/agents/{agent}", map_location=lambda storage, loc: storage))
		self.policy_old.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_401/agents/{agent}", map_location=lambda storage, loc: storage))
		self.policy.load_state_dict(torch.load(f"Experiments/Experiment_component_{component}_random_401/agents/{agent}", map_location=lambda storage, loc: storage))
